	...
	public CaratteristicheRuleBook() {
	  ...
	  public void defineRules() {
	    ...
	    addRule(RuleBuilder.create().withResultType(Boolean.class).withName("Rule1")
	      .when(facts -> 
	      	facts.getStrVal("CLSTATF").equalsIgnoreCase("t04") ||
	      ...
	      .then( (facts, result) ->  System.out.println("Risultato Rule1 " + result.getValue()))
	      .stop()
	      .build());
	    ...
	    addRule(RuleBuilder.create().withResultType(Boolean.class).withName("Rule2")
	      .when(facts -> 
	      	facts.getStrVal("CLLEGA").substring(0,1).equalsIgnoreCase("1") &&
	      	facts.getStrVal("CLSTATF").substring(0,2).equalsIgnoreCase("h3")
	    		  )
	      .then((facts, result) -> result.setValue(Boolean.FALSE))
	      .then( (facts, result) ->  System.out.println("Risultato Rule2 " + result.getValue()))
	      .stop()
	      .build());
...
// **********************************************	    
	    ...
	    addRule(RuleBuilder.create().withResultType(Boolean.class).withName("Rule3")
	      .when(facts ->
	      	facts.getStrVal("CLLEGA").substring(0, 1).equalsIgnoreCase("3") 
	       )
	    ...
	    addRule(RuleBuilder.create().withResultType(Boolean.class)
	  	      .when(facts ->
	  	      	facts.getStrVal("CLSTAF").substring(1, 2).equalsIgnoreCase("h3") 
	    ...
	    addRule(RuleBuilder.create().withResultType(Boolean.class)
		  	      .when(facts ->
		  	      	facts.getStrVal("CLLEGA").equalsIgnoreCase("3a") && (
	    ...
	    addRule(RuleBuilder.create().withResultType(Boolean.class)
		  	      .when(facts ->
		  	      	facts.getStrVal("SLBPTE").equalsIgnoreCase("b07187") ||
	    ...
	    addRule(RuleBuilder.create().withResultType(Boolean.class)
		  	      .when(facts ->
		  	      	facts.getStrVal("SLBPTE").equalsIgnoreCase("slbp") &&
...
// ***************************
	    addRule(RuleBuilder.create().withResultType(Boolean.class)
	  	      .when(facts ->
	  	      	facts.getStrVal("CLLEGA").substring(1, 1).equalsIgnoreCase("4") &&
	    ...
	    addRule(RuleBuilder.create().withResultType(Boolean.class)
		  	      .when(facts ->
		  	      	!facts.getStrVal("CLLEGA").substring(1, 1).equalsIgnoreCase("6") 
		  	       )
		  	      .then((facts, result) -> result.setValue(Boolean.TRUE))
		  	      .stop()
		  	      .build());
	    ...
	    addRule(RuleBuilder.create().withResultType(Boolean.class)
		  	      .when(facts ->
		  	      	facts.getStrVal("CLLEGA").substring(1, 1).equalsIgnoreCase("8") &&
		  	        facts.getStrVal("CLSTATF").substring(1, 2).equalsIgnoreCase("h3") 
		  	       )
		  	      .then((facts, result) -> result.setValue(Boolean.TRUE))
		  	      .stop()
