...
public class RuleBA_LB_2 {
	...
	public RuleState then()
	{
		...
		result.add(new LivelloDistinta(new GenericItem("LB" + caratteristiche.stream().filter(caratteristica -> "CLLEGA".equals(caratteristica.getCaratteristicaId())).findAny().get().getSelectedValue() + 
