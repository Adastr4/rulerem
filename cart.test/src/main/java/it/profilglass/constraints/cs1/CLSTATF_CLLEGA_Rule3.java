...
@Rule(order = 1, name="Rule3") // order specifies the order the rule should execute in; if not specified, any
					// order may be used
public class CLSTATF_CLLEGA_Rule3 {
	...
	@When
	public boolean when() {
//		System.out.println("executing rule 4 package cs1");
...
//		System.out.println("executed rule 4 package cs1");
