...
public class Main {
	...
	public static Object testMLSTATFRuleStandard(String string, String string2, String string3, String string4,
			Integer clspess, String string5, String string6, String string7) {
